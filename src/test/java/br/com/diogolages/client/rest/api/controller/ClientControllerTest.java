package br.com.diogolages.client.rest.api.controller;
...
import br.com.diogolages.client.rest.api.dto.ClientDTO;
import br.com.diogolages.client.rest.api.entity.Client;
import br.com.diogolages.client.rest.api.service.ClientService;
...
class ClientControllerTest {
	...
	private void startClient() {
		client = new Client(ID, NAME, CPF, ADDRESS, EMAIL);
		clientDTO = new ClientDTO(ID, NAME, CPF, ADDRESS, EMAIL);
	}
